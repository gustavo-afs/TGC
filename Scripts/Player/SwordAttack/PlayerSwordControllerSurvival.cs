...
public class PlayerSwordControllerSurvival : MonoBehaviour {
	...
	void SwordtIt(){
		...
		if (Physics.Raycast (swordRay, out swordCollided, swordRange, collidableMask)) {
			...
			EnemyHealthControllerSurvival enemyHealthController = swordCollided.transform.GetComponent<EnemyHealthControllerSurvival>();
